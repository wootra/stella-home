...
export default class SampleTestsSYKim extends Component {
  render() {
    const arrs = [
      { url: "/sykim/samples/dropdown", text: "DropDown", class: [DropDownMenuSample] },
      { url: "/sykim/samples/map", text: "Map", class: [MapTest] },
      { url: "/sykim/samples/redux", text: "Redux", class: [ActionSenderSample, ReduxReceiverSample, ReduxReceiverSample2, ActionSenderReduxReceiverSample] },
      { url: "/sykim/samples/fontawesome", text: "FontAwesome", class: [FontAwesomeTest] },
      { url: "/sykim/samples/login", text: "Login", class: [LoginSample] },
      { url: "/sykim/samples/gallaryCompo", text: "gallary-compo", class: [GallaryCompoSample] },
      { url: "/sykim/samples/starRating", text: "Star rating", class: [StarRatingSample] },
    ];
